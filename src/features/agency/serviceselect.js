...
console.log('🚀 [SCRIPT] About to call initServiceSelect()')
initServiceSelect()
console.log('🚀 [SCRIPT] initServiceSelect() completed')

// Export
export default initServiceSelect

// Test functions (keep existing ~2546-2612)
...
// No more duplicate calls - main.js imports and calls initServiceSelect once
console.log('🚀 [SCRIPT] serviceselect.js loaded cleanly')
